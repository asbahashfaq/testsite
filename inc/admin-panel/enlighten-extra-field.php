...
$enlighten_sidebar_layout = array(
        'left-sidebar' => array(
                        'value'     => 'left',
                        'label'     => __( 'Left sidebar', 'enlighten' ),
                        'thumbnail' => get_template_directory_uri() . '/images/left-sidebar.png'
                    ), 
        'right-sidebar' => array(
                        'value' => 'right',
                        'label' => __( 'Right sidebar', 'enlighten' ),
                        'thumbnail' => get_template_directory_uri() . '/images/right-sidebar.png'
                    ),
        'both-sidebar' => array(
                        'value'     => 'both',
                        'label'     => __( 'Both Sidebar', 'enlighten' ),
                        'thumbnail' => get_template_directory_uri() . '/images/both-sidebar.png'
                    ),
       
        'no-sidebar' => array(
                        'value'     => 'no',
                        'label'     => __( 'No sidebar', 'enlighten' ),
...
<table class="form-table">
    <tr>
        <td colspan="4"><em class="f13"><?php _e('Choose Sidebar Template','enlighten'); ?></em></td>
    </tr>
