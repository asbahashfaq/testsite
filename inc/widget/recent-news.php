...
class enlighten_recent_news extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'enlighten_recent_news', 'Enlighten : Recent News', array(
            'description' => __('A widget that shows Recent News', 'enlighten')
                )
        );
    }
    ...
    private function widget_fields() {
        ...
        $fields = array(
            ...
            'recent_news_title' => array(
                ...
                'enlighten_widgets_title' => __('Recent News Title', 'enlighten'),
                'enlighten_widgets_field_type' => 'text',
            ),
            'recent_news_cat' => array(
                'enlighten_widgets_name' => 'recent_news_cat',
                'enlighten_widgets_title' => __('Recent News Category', 'enlighten'),
                        ...
                        while($enlighten_rn_query->have_posts()):
                            ...
                            ?>
                                <div class="rn_post_loop">
                                    ...
                                    <?php 
                                        $enlighten_image_url = wp_get_attachment_image_src(get_post_thumbnail_id(),'footer_recent_news');
