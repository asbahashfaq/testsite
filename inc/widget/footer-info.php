...
class enlighten_info extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'enlighten_info', 'Enlighten : Footer Info', array(
            'description' => __('A widget that shows information', 'enlighten')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'title_info' => array(
                ...
                'enlighten_widgets_title' => __('Info Title', 'enlighten'),
                'enlighten_widgets_field_type' => 'text',
            ),
            'location' => array(
                'enlighten_widgets_name' => 'location',
                'enlighten_widgets_title' => __('Location', 'enlighten'),
                'enlighten_widgets_field_type' => 'text',
            ),
            'phone' => array(
                'enlighten_widgets_name' => 'phone',
                'enlighten_widgets_title' => __('Phone', 'enlighten'),
                'enlighten_widgets_field_type' => 'text',
            ),
            'fax' => array(
                'enlighten_widgets_name' => 'fax',
                'enlighten_widgets_title' => __('Fax', 'enlighten'),
                'enlighten_widgets_field_type' => 'text',
            ),
            'email' => array(
                'enlighten_widgets_name' => 'email',
                'enlighten_widgets_title' => __('Email', 'enlighten'),
                'enlighten_widgets_field_type' => 'text',
            ),
