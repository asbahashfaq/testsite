...
function enlighten_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    ...
    switch ($enlighten_widgets_field_type) {
        ...
        case 'text' :
            ?>
            <p>
                <label for="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>"><?php echo wp_kses_post($enlighten_widgets_title); ?>:</label>
                <input class="widefat" id="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>" name="<?php echo $instance->get_field_name($enlighten_widgets_name); ?>" type="text" value="<?php echo $athm_field_value; ?>" />
        ...
        case 'textarea' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>"><?php echo wp_kses_post($enlighten_widgets_title); ?>:</label>
                <textarea class="widefat" rows="<?php echo $enlighten_widgets_row; ?>" id="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>" name="<?php echo $instance->get_field_name($enlighten_widgets_name); ?>"><?php echo wp_kses_post($athm_field_value); ?></textarea>
            </p>
            <?php
            break;
        ...
        case 'checkbox' :
            ?>
            <p>
                <input id="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>" name="<?php echo $instance->get_field_name($enlighten_widgets_name); ?>" type="checkbox" value="1" <?php checked('1', $athm_field_value); ?>/>
                <label for="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>"><?php echo wp_kses_post($enlighten_widgets_title); ?></label>
        ...
        case 'radio' :
            ...
            <p>
                ...
                foreach ($enlighten_widgets_field_options as $athm_option_name => $athm_option_title) {
                    ?>
                    <input id="<?php echo $instance->get_field_id($athm_option_name); ?>" name="<?php echo $instance->get_field_name($enlighten_widgets_name); ?>" type="radio" value="<?php echo $athm_option_name; ?>" <?php checked($athm_option_name, $athm_field_value); ?> />
        ...
        case 'select' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>"><?php echo wp_kses_post($enlighten_widgets_title); ?>:</label>
                <select name="<?php echo $instance->get_field_name($enlighten_widgets_name); ?>" id="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>" class="widefat">
        ...
        case 'number' :
            ?>
            <p>
                <label for="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>"><?php echo wp_kses_post($enlighten_widgets_title); ?>:</label><br />
                <input name="<?php echo $instance->get_field_name($enlighten_widgets_name); ?>" type="number" step="1" min="1" id="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>" value="<?php echo wp_kses_post($athm_field_value); ?>" class="small-text" />
            ...
            <p>
                ...
                <select name="<?php echo $instance->get_field_name($enlighten_widgets_name); ?>" id="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>" class="widefat">
                    <?php foreach ($enlighten_postlist as $enlighten_single_post) { ?>
                        <option value="<?php echo $enlighten_single_post['value']; ?>" id="<?php echo $instance->get_field_id($enlighten_single_post['label']); ?>" <?php selected($enlighten_single_post['value'], $athm_field_value); ?>><?php echo wp_kses_post($enlighten_single_post['label']); ?></option>
                    <?php } ?>
                </select>
        ...
        case 'upload' :
            ...
            $output = '';
            $id = $instance->get_field_id($enlighten_widgets_name);
            $class = '';
            $int = '';
            $value = $athm_field_value;
            $name = $instance->get_field_name($enlighten_widgets_name);
            ...
            $output .= '<input id="' . $id . '" class="upload' . $class . '" type="text" name="' . $name . '" value="' . $value . '" placeholder="' . __('No file chosen', 'enlighten') . '" />' . "\n";
            if (function_exists('wp_enqueue_media')) {
                    $output .= '<input id="upload-' . $id . '" class="upload-button button" type="button" value="' . __('Upload', 'enlighten') . '" />' . "\n";
            } else {
                $output .= '<p><i>' . __('Upgrade your version of WordPress for full media support.', 'enlighten') . '</i></p>';
            }

            $output .= '<div class="screenshot team-thumb" id="' . $id . '-image">' . "\n";

            if ($value != '') {
                $remove = '<a class="remove-image">'. __('Remove', 'enlighten').'</a>';
        ...
        case 'icon' :
            ...
            <p>
                ...
                <input class="hidden-icon-input" name="<?php echo $instance->get_field_name($enlighten_widgets_name); ?>" type="hidden" id="<?php echo $instance->get_field_id($enlighten_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" />
...
function enlighten_widgets_updated_field_value($widget_field, $new_field_value) {
    ...
    if ($enlighten_widgets_field_type == 'number') {
        ...
        if (!isset($enlighten_widgets_allowed_tags)) {
            // If not, fallback to default tags
            $enlighten_widgets_allowed_tags = '<p><strong><em><a>';
        }
        return strip_tags($new_field_value, $enlighten_widgets_allowed_tags);
