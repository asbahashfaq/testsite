            ...
            <div class="effect_title">
                ...
                <div class="section_title">
                    <?php if($enlighten_section_title_one){ ?>
                        <span class="title_one wow fadeInUp"><?php echo esc_attr($enlighten_section_title_one); ?></span>
                    <?php } ?>
                    <?php if($enlighten_section_title_two){ ?>
                        <span class="title_two wow fadeInUp"><?php echo esc_attr($enlighten_section_title_two); ?></span>
                    <?php } ?>
                ...
                <?php
                        ...
                        <div class="array_service"> <?php
                                foreach($enlighten_post_arrays as $enlighten_posts){
                                    $enlighten_image = wp_get_attachment_image_src(get_post_thumbnail_id($enlighten_posts),'service_image');
                                        ...
                                        <?php } ?>
                                            <div class="title_content_service wow fadeInUp">
                                                <?php if($enlighten_content){ ?>
                                                    <div class="service_content"><?php echo esc_attr(wp_trim_words($enlighten_content,'15','...')); ?></div>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    <?php
