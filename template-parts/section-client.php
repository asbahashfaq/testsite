                    ...
                    <div class="after-effet1"></div>
                        <div class="section_title">
                              <?php if($enlighten_section_title){ ?>
                                <span class="title_one wow fadeInUp"><?php echo esc_attr($enlighten_section_title); ?></span>
                                <?php } ?>
                                <?php if($enlighten_section_title_sub){ ?>
                                <span class="title_two wow fadeInUp"><?php echo esc_attr($enlighten_section_title_sub); ?></span>
                                <?php } ?>
                        </div>
                    </div>
                <?php } ?>
                    ...
                    <div class="client_cat_loop wow fadeInUp">
                        <?php
                            ...
                            if($enlighten_client_query->have_posts()):
                                ...
                                $enlighten_image = wp_get_attachment_image_src(get_post_thumbnail_id(),'client_section');
