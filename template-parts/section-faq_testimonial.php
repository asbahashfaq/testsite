...
<div class="ak-container">
    <div class="test_faq_wrap">
            ...
            <div  class="faq_wrap wow fadeInLeft">
                <span class="faq_title"><?php echo esc_attr($enlighten_faq_title); ?></span>
                                ...
                                if($enlighten_faq_query->have_posts()):
                                    while($enlighten_faq_query->have_posts()):
                                        $enlighten_faq_query->the_post();
                                            ?>
                                                <li class="faq_qa <?php echo esc_attr(get_the_ID()); ?>">
            ...
            <div class="test_wrap wow fadeInRight">
                <span class="title_test"><?php echo esc_attr($enlighten_testimonial_title); ?></span>
                            ...
                            <?php
                                ...
                                if($enlighten_test_query->have_posts()):
                                    while($enlighten_test_query->have_posts()):
                                        ...
                                        $enlighten_image = wp_get_attachment_image_src(get_post_thumbnail_id(),'testimonial_image');
