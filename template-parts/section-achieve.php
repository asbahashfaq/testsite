            ...
            <div class="section_content_wrap">
                <div class="section_title">
                    <?php if($enlighten_achieve_title){ ?>
                        <span class="title_one wow fadeInUp"><?php echo esc_attr($enlighten_achieve_title); ?></span>
                    <?php } ?>
                    <?php if($enlighten_achieve_title_sub){ ?>
                        <span class="title_two wow fadeInUp"><?php echo esc_attr($enlighten_achieve_title_sub); ?></span>
                    <?php } ?>
                </div>
            </div>
        </div>
    ...
    <div class="wrap_counter clearfix">
        <?php if($enlighten_image_1 || $enlighten_fa_icon_1 || $enlighten_archive_count_1 || $enlighten_achieve_title_1){ ?>
            ...
            <?php if($enlighten_archive_count_1){ ?>
                <span class="counter_count"><?php echo esc_attr($enlighten_archive_count_1); ?></span>
            <?php } ?>
            <?php if($enlighten_achieve_title_1){ ?>
                <span class="counter_title"><?php echo esc_attr($enlighten_achieve_title_1); ?></span>
            <?php } ?>
            </div>
        <?php } ?>
        <!------------------------------------------------------------------------------->
        <?php if($enlighten_image_2 || $enlighten_fa_icon_2 || $enlighten_archive_count_2 || $enlighten_achieve_title_2){ ?>
            ...
            <?php if($enlighten_archive_count_2){ ?>
                <span class="counter_count"><?php echo esc_attr($enlighten_archive_count_2); ?></span>
            <?php } ?>
            <?php if($enlighten_achieve_title_2){ ?>
                <span class="counter_title"><?php echo esc_attr($enlighten_achieve_title_2); ?></span>
            <?php } ?>
            </div>
        <?php } ?>
        <!------------------------------------------------------------------------------->
        <?php if($enlighten_image_3 || $enlighten_fa_icon_3 || $enlighten_archive_count_3 || $enlighten_achieve_title_3){ ?>
            ...
            <?php if($enlighten_archive_count_3){ ?>
                <span class="counter_count"><?php echo esc_attr($enlighten_archive_count_3); ?></span>
            <?php } ?>
            <?php if($enlighten_achieve_title_3){ ?>
                <span class="counter_title"><?php echo esc_attr($enlighten_achieve_title_3); ?></span>
            <?php } ?>
            </div>
        <?php } ?>
        <!------------------------------------------------------------------------------->
        <?php if($enlighten_image_4 || $enlighten_fa_icon_4 || $enlighten_archive_count_4 || $enlighten_achieve_title_4){ ?>
            ...
            <?php if($enlighten_archive_count_4){ ?>
                <span class="counter_count"><?php echo esc_attr($enlighten_archive_count_4); ?></span>
            <?php } ?>
            <?php if($enlighten_achieve_title_4){ ?>
                <span class="counter_title"><?php echo esc_attr($enlighten_achieve_title_4); ?></span>
            <?php } ?>
            </div>
        <?php } ?>
    </div>
