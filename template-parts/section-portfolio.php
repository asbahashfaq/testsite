            ...
            ?> <div class="ak-container"><?php
                    ...
                    <div class="effect_title">
                        ...
                        <div class="section_title">
                              <?php if($enlighten_title_one){ ?>
                                <span class="title_one wow fadeInUp"><?php echo esc_attr($enlighten_title_one); ?></span>
                                <?php } ?>
                                <?php if($enlighten_title_two){ ?>
                                <span class="title_two wow fadeInUp"><?php echo esc_attr($enlighten_title_two); ?></span>
                                <?php } ?>
                        </div>
                    </div>
                    <?php } ?>
                    <div class="portfolio_slider_wrap"> <?php
                            while($enlighten_port_query->have_posts()):
                                ...
                                $enlighten_image_port = wp_get_attachment_image_src(get_post_thumbnail_id(),'portfolio_image');
                                        ...
                                        <div class="title_content_wrap">
                                            ...
                                            <div class="anchor_title_wrap">
                                                <span class="port_title wow fadeInUp">
                                                    <a href="<?php the_permalink(); ?>"><?php echo esc_attr($enlighten_title); ?></a>
                                                </span>
                                            </div>
                                            <?php } ?>
